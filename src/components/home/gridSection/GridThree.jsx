...
const GridThree = () => {
  ...
  return (
    <motion.div className='flex flex-col rounded-md items-center justify-center w-[70%]  md:w-full lg:w-[80%] bg-scheme-darkerGrey' ref={ref} variants={scrollVariant} initial='hidden' animate={animation}>
