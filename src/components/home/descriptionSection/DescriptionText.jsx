...
const DescriptionText = () => {
  ...
  return (
    <motion.div className="w-full sm:w-1/2 h-1/2 sm:h-full flex flex-col gap-5 justify-center items-center" ref={ref} variants={scrollVariant} animate={animation} initial='hidden'>
