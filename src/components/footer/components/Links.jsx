...
const Links = () => {
  return (
    <div
      className={`flex md:gap-6 lg:gap-6 sm:gap-6 flex-col justify-self-center self-center w-full md:w-[30%]  text-white ${montserrat.className}`}
    >
      <p
        className={`text-xl text-scheme-greenOne self-center  ${ubuntu.className}`}
      >
        Useful Links
      </p>
